...
namespace DoAnPTTKHDT.Areas.Admin.Controllers
{
    public class QuanlynhaxuatbanController : Controller
    {
        ...
        // GET: Admin/Quanlynhaxuatban
        public ActionResult Index()
        {
            return View(db.NHAXUATBAN.ToList());
        }

        // GET: Admin/Quanlynhaxuatban/Details/5
        ...
        // GET: Admin/Quanlynhaxuatban/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/Quanlynhaxuatban/Create
        ...
        // GET: Admin/Quanlynhaxuatban/Edit/5
        ...
        // POST: Admin/Quanlynhaxuatban/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/Quanlynhaxuatban/Delete/5
        ...
        // POST: Admin/Quanlynhaxuatban/Delete/5
